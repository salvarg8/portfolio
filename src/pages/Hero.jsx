      ...
      <div className='grid grid-cols-1 md:grid-cols-2'>
        ...
        <div className='p-10 md:p-15 lg:p-30 xl:p36'>
          ...
          <div className='p-10 flex justify-center gap-4'>
            <a className='bg-[#527987] py-2 px-12 rounded-3xl hover:bg-[#3a5a6b] transition-colors duration-300 cursor-pointer'>Ver Proyectos</a>
            <a className='bg-[#527987] py-2 px-12 rounded-3xl hover:bg-[#3a5a6b] transition-colors duration-300 cursor-pointer'>Contactar</a>
          </div>
        </div>
